...
//   - The file BYTES live in the object store (GCS) — see storage_gcs.go.
...
// The only implementation is gcsStorage (storage_gcs.go); tests exercise that
// same implementation against the dev bucket.
